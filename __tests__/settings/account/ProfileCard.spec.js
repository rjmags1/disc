...
describe('ProfileCard', () => {
    test('renders a div containing prof. card. avatar and 3 headers', () => {
        render(<ProfileCard 
                avatarSrc="/test-src" name="test-name" email="test-email"/>)

        expect(screen.getByTestId("profile-card-container")).   
            toBeInTheDocument()

        expect(screen.getByTestId("profile-card-avatar-container")).
            toBeInTheDocument()
